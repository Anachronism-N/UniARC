...
# Source: Anachronism-N/UniARC, code/model/model_llama2_wavtokenizer_prompt.py
...
class IS(pl.LightningModule):
    ...
    def __init__(self, wavtokenizer_ckpt_path: str=None, wavtokenizer_config_path: str=None, hubert_ckpt_path: str=None, llama_ckpt_path: str=None, task_prompt: str='Identify the text corresponding to the speech: ', learning_rate: float=1e-05):
        ...
        self.audio_embedding_last_Linear = nn.Sequential(nn.Linear(5120, 8192), nn.ReLU(), nn.Linear(8192, self.llama.config.hidden_size))
