...
# Source: Anachronism-N/UniARC, code/model/model_llama2_continus_prompt.py
...
class IS(pl.LightningModule):
    ...
    def __init__(self, hubert_ckpt_path: str=None, llama_ckpt_path: str=None, task_prompt: str='Identify the text corresponding to the speech: ', learning_rate: float=1e-05):
