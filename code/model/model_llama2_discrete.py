...
class IS(pl.LightningModule):
    ...
    def forward(self,inputs):
        ...
        audio_lengths=torch.tensor(len_x1).clone().detach()
        ...
        attns_audio=make_pad_mask_number(audio_lengths).to(x.device)
        #加2是因为bos和eos
