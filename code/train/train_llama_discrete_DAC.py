...
model=IS(DAC_path=DAC_model_path,llama_ckpt_path=llama_ckpt_path)
# model = model.float()
...
# trainset = ASRDataset("/commondocument/group2/ASRCompare/data/rough_data/rough.scp", "/commondocument/group2/ASRCompare/data/rough_data/rough.txt")
# valset = ASRDataset("/commondocument/group2/ASRCompare/data/rough_data/rough.scp", "/commondocument/group2/ASRCompare/data/rough_data/rough.txt")
...
checkpoint_callback = ModelCheckpoint(
        dirpath='/commondocument/group2/ASRCompare/code/model/ckpt/DAC_asr_LS100',
        filename='{epoch:02d}-{train_loss:.3f}-{val_loss:.3f}-DAC',
        save_top_k=2,
        every_n_epochs=1,
        monitor='val_loss',
        mode='min',
...
trainer = pl.Trainer(
    ...
    logger=TensorBoardLogger(name='DAC_ASR_LS100',save_dir='/commondocument/group2/ASRCompare/code/train/log'),
    accelerator='gpu',
    num_nodes=1,
    devices=[4,5,6,7],
