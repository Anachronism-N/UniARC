...
from model.model_llama2_wavlm_prompt import IS
...
model = IS.load_from_checkpoint(
    "/commondocument/group2/ASRCompare/code/model/8B_ckpt/wavlm_cremad/epoch=08-train_loss=0.365-val_loss=0.424_continuous.ckpt",
...
# test_set_clean=ASRDataset("/commondocument/group2/ASRCompare/data/dev_clean/dev_clean.scp", "/commondocument/group2/ASRCompare/data/dev_clean/dev_clean.txt")
...
# test_set_clean=ASRDataset("/commondocument/group2/ASRCompare/data/sdd_final_split/train.scp", "/commondocument/group2/ASRCompare/data/sdd_final_split/train.txt")
...
fdir="/commondocument/group2/ASRCompare/code/inference/8B/wavlm_cremad"
